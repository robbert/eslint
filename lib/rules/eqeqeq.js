...
module.exports = {
    ...
    create: function(context) {
        ...
        /**
         * Checks if one of the operands is a literal string
         * @param {ASTNode} node The node to check
         * @returns {boolean} if operand is string
         * @private
         */
        function isStringCheck(node) {
            return (node.right.type === "Literal" && typeof (node.right.value) === "string") ||
        ...
        return {
            BinaryExpression: function(node) {
                ...
                if (
                    ...
                    isStringCheck(node) && isTypeOfBinary(node)
                ) {
                    return;
                }
